...
public class App extends Application {
	...
	imgUnit.getProjection().addImage(new Image(getImagesPath() + "player character" + fileSeperator + "front face" + fileSeperator + "base_0.png", 20, 150, false, true));
