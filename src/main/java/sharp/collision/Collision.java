...
public class Collision {
	...
	return collides(c1.getCollider(), c2.getCollider());
    }

    public static boolean collides(Projector p1, Projector p2) {
	if (p1.getCollisionRadius() + p2.getCollisionRadis() >
	    CVector.add(p1.getPosition(), p2.getPosition()).getMag()) {
	    return collides(p1.getPolygon(), p2.getPolygon());
	}
	return false;
    }
