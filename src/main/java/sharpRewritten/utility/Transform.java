...
public class Transform {
	...
	if (isTranslation()) {
	    return new Force(e -> e.getAcceleration().add(new CVector(x * multiplier, y * multiplier)));
	} else {
	    return new Force(e -> e.getRotAcceleration().setValue(e.getRotAcceleration().getValue() + rot * multiplier));
	}
    }
